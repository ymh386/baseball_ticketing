	...
	<div class="row col-md-8 offset-md-2" style="min-height: 60vh">
		<!-- contents 내용 작성 -->
		 <div class="container text-center mb-5">
			<h1 class="mb-5">${dto.stadiumName}</h1>
			 <c:choose>
				 <c:when test="${dto.stadiumNum eq 3}"><img src="/resources/images/stadiums/Jamsil.webp" width="1000" height="500"></c:when>
				 <c:when test="${dto.stadiumNum eq 4}"><img src="/resources/images/stadiums/Gochuck.webp" width="1000" height="500"></c:when>
				 <c:when test="${dto.stadiumNum eq 5}"><img src="/resources/images/stadiums/SSG.webp" width="1000" height="500"></c:when>
				 <c:when test="${dto.stadiumNum eq 6}"><img src="/resources/images/stadiums/KT.webp" width="1000" height="500"></c:when>
				 <c:when test="${dto.stadiumNum eq 7}"><img src="/resources/images/stadiums/Hanwha.webp" width="1000" height="500"></c:when>
				 <c:when test="${dto.stadiumNum eq 8}"><img src="/resources/images/stadiums/KIA.webp" width="1000" height="500"></c:when>
				 <c:when test="${dto.stadiumNum eq 9}"><img src="/resources/images/stadiums/Samsung.webp" width="1000" height="500"></c:when>
				 <c:when test="${dto.stadiumNum eq 10}"><img src="/resources/images/stadiums/Lotte.webp" width="1000" height="500"></c:when>
				 <c:otherwise><img src="/resources/images/stadiums/NC.webp" width="1000" height="500"></c:otherwise>
			 </c:choose>
		 </div>
			  ...
			  <div class="col">
				<form>
					...
					<div class="mb-3">
						...
						<c:choose>
						  	<c:when test="${dto.stadiumNum eq 3}"><input type="text" class="form-control" value="1루(횸)/3루(원정)" readonly></c:when>
